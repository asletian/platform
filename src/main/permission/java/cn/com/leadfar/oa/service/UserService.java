...
public interface UserService {
	 ...
	 * 本查询主要用于“用户管理主界面”，在这个界面上，需要显示出所有的人员及其帐号，对于
	 * 未分配帐号的人员，可以分配帐号
	 * @param personName
	...
	/**
	 * 根据人员姓名，查询：人员ID、人员姓名，不分页
	 * 本查询主要用于“用户授权”界面，在这个界面上，需要显示出所有已分配了登录帐号的人员
	 * 列表。如果某个人员尚未分配登录帐号，则无需查询出来。
	 * @param personName 人员姓名，查询条件
